...
1. EP scanner schema validation
You now know EP always returns:
- Symbol
- Gap%
- CatalystScore
- CatalystStrength
...
It confirms EP correctly calls:
- Catalyst Engine v2
- Strategy Engine v2
3. Filtering logic validation
- Small gaps are filtered
- Missing fields don’t crash the scanner
