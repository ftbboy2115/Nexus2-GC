...
import { SchedulerCard, EngineCard, MonitorCard, ApiUsageCard, QuickActionsCard, SignalsCard, PositionsCard } from '@/components/automation'
                    ...
                    <>
                        ...
                        <div className={styles.grid}>
                            ...
                            <QuickActionsCard
                                ...
                                actionLoading={actionLoading}
                                onUpdateSettings={updateScannerSettings}
                                onRunScan={() => handleAction('scan', '/automation/scan-all', {
                                ...
                                onDryRun={() => handleAction('dry-run', '/automation/scan_and_execute')}
                                onCheckPositions={() => handleAction('check', '/automation/monitor/check')}
                                onLiquidateAll={() => setShowLiquidateModal(true)}
                            />

                            {/* Signal Stream */}
                            <SignalsCard signalStream={signalStream} />
                            ...
                            <PositionsCard
                                ...
                                positionsMaximized={positionsMaximized}
                                positionSort={positionSort}
                                columns={columnConfig.columns}
                                allColumns={columnConfig.allColumns}
                                onMaximizeToggle={() => setPositionsMaximized(!positionsMaximized)}
                                onSortChange={setPositionSort}
                                onExportCsv={exportPositionsToCsv}
                                onOpenColumnEditor={() => { columnConfig.openEditor(); setShowColumnEditor(true) }}
                            />
