...
from nexus2.api.routes import health, orders, positions, scanner, trade, settings, websocket, automation, watchlist, analytics, automation_simulation, ma_check_routes, monitor_routes, scheduler_routes, docs_routes, preferences, warrior_routes, trade_event_routes, lab_routes, audit_routes, data_routes  # v3
