...
async def check_entry_triggers(engine: "WarriorEngine") -> None:
    ...
    for symbol, watched in list(engine._watchlist.items()):
        try:
            ...
            # =============================================================================
            # These are CHART-STRUCTURE patterns that detect consolidation → breakout
            # regardless of pre-market high relationship. They can form at any price level.
            ...
            # BULL FLAG: "First green after pullback" — pullback continuation at any level
            ...
            # INVERTED HEAD & SHOULDERS: Reversal pattern at any price level
            ...
            # CUP & HANDLE: Consolidation → breakout (often at VWAP)
            # LRHC: Ross entered Cup & Handle VWAP break at $5.30, PMH was $8.10
